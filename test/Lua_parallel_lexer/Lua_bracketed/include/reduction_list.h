...
static inline uint32_t get_reduction_position_at_index(reduction_list *list, uint32_t index)
{
...
static inline void swap_reduction_lists(reduction_list **src, reduction_list **dst)
{
...
static inline void free_reduction_list(reduction_list *list)
{
    free(list->list);
    free(list);
}
