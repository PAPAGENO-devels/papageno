...
delimiter *push_delimiter_on_stack(delimiter_stack *stack, delimiter_type type, int8_t type_class, uint32_t number_tokens_from_last_comment, token_node* last_token, uint32_t realloc_size)
{
	...
	new_delimiter->number_tokens_from_last_comment = number_tokens_from_last_comment;
...
{
  delimiter *d = push_delimiter_on_stack(stack, type, type_class, number_tokens_from_last_comment, last_token, realloc_size);
